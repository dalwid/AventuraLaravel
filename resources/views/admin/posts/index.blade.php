    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="w-full mb-10 flex justify-end">
                <a href="{{ route('admin.posts.create') }}" class="px-4 py-2 shadow rounded
                                   text-white text-bold bg-green-700 hover:bg-green-900
                                   transition ease-in-out duration-300">Criar Post</a>
            </div>
                ...
                <table class="w-full bg-white rounded shadow p-4">
                    <thead>
                        <tr>
                            ...
                            <th class="px-2 py-4 text-left">Estatus</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-2 py-4 text-left flex gap-2">
                                <a href="{{ route('admin.posts.edit', $post->id) }}" class="px-4 py-2 shadow rounded
                                                   text-white text-bold bg-blue-700 hover:bg-blue-900
                                                   transition ease-in-out duration-300">Editar</a>
                                ...
                                <form action="{{ route('admin.posts.destroy', $post->id) }}" method="POST">
                                    ...
                                    <button class="px-4 py-2 shadow rounded
                                                   ...
                                                   transition ease-in-out duration-300">Deletar</button>
                                </form>
                            </td>
